...
import { CreateAvatarSchama, CreateElementSchema, CreateMApELementSechma, CreateMapSchema, CreateSpaceElementSchema, CreateSpaceSchema } from "../types";
...
export const createSpace = asyncHandler(async(req : Request | any, res : Response)=> {
    ...
    const space = await client.space.create({
        data : {
            ...
            creatorId : req.userId,// user middleware
        },
    });
    if(!space) {
